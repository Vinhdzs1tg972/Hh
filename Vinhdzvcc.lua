...
loadstring(game:HttpGet('https://raw.githubusercontent.com/asher-realrise/project/refs/heads/main/loadder.lua'))()
  ...
  AddButton(Tab1o, {
     Name = "Zero Hub",
    Callback = function()
	  loadstring(game:HttpGet("https://raw.githubusercontent.com/GoblinKun009/Script/refs/heads/main/ZeroHub", true))()
  end
  })
  AddButton(Tab1o, {
     Name = "King Rua Hub",
  ...
  AddButton(Tab1o, {
     Name = "Zyrox Hub",
    Callback = function()
	  loadstring(game:HttpGet("https://raw.githubusercontent.com/vinh129150/ZyroXstore/refs/heads/main/Bloxfruits.lua"))()
  end
  })
  AddButton(Tab1o, {
     Name = "Cokka Hub",
    Callback = function()
	  loadstring(game:HttpGet("https://keyscripthub.vercel.app/cokka.lua"))()
  end
  })
